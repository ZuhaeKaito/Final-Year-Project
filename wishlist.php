...
<head>
    ...
    <title>Guitarlicious - wishlist</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>wishlist</h1>
            <p>It's your personal canvas for crafting the perfect collection of instruments. </p>
    ...
    <section class="shop">
        ...
        ?>
            ...
            <form method="post" class="box">
                ...
                <div class="icon">
                    <a href="view_page.php?pid=<?php echo $fetch_wishlist['pid']; ?>" class="bi bi-eye-fill"></a> <!-- Fixed the product ID passed to view_page.php -->
        ...
        <div class="wishlist_total">
            ...
            <a href="shop.php" class="btn">Add More</a>
